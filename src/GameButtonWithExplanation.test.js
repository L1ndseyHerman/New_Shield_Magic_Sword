...
it("renders enabled Shield button + explanation", () => {
  ...
  act(() => {
    render(<GameButtonWithExplanation buttonColor="darkolivegreen" buttonText="Shield" 
      explanation="Blocks two physical damage." isDisabled={false} />, container);
  });
...
it("renders disabled Shield button + explanation", () => {
  ...
  act(() => {
    render(<GameButtonWithExplanation buttonColor="darkolivegreen" buttonText="Shield" 
      explanation="Blocks two physical damage." isDisabled={true} />, container);
  });
...
it("renders enabled Magic button + explanation", () => {
  ...
  act(() => {
    render(<GameButtonWithExplanation buttonColor="royalblue" buttonText="Magic" 
      explanation="Deals one magic damage." isDisabled={false} />, container);
  });
...
it("renders disabled Magic button + explanation", () => {
  ...
  act(() => {
    render(<GameButtonWithExplanation buttonColor="royalblue" buttonText="Magic" 
      explanation="Deals one magic damage." isDisabled={true} />, container);
  });
...
it("renders enabled Sword button + explanation", () => {
  ...
  act(() => {
    render(<GameButtonWithExplanation buttonColor="firebrick" buttonText="Sword" 
      explanation="Deals two physical damage." isDisabled={false} />, container);
  });
...
it("renders disabled Sword button + explanation", () => {
  ...
  act(() => {
    render(<GameButtonWithExplanation buttonColor="firebrick" buttonText="Sword" 
      explanation="Deals two physical damage." isDisabled={true} />, container);
  });
